                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-6 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="postbp.php" method="post" enctype="multipart/form-data">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xxl-12 col-12 mb-3">
                                                <div class="form-file">
                                                    <label class="form-label">Blog Post Header Image:</label><br>
                                            ...
                                            <div class="col-xxl-12 col-12 mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Title" name="name" id="name" required>
                                            </div>
                                            <div class="col-xxl-12 col-12 mb-3">
                                                <label class="form-label">Content:</label><br>
                                                <textarea  id="basic-example" name="content" rows="8" cols="160"  style="border:1px solid #e5e5e5;border-radius: 5px;"  ></textarea>
                                            </div>
