...
$editimagevariable=$_POST['imagevariable'];
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM special_images WHERE role ='$editimagevariable'  ") or die('Error197');
                         ...
                         echo '
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Update Special Image</h4>
                                </div>
                                <div class="card-body">
                                    <form action="postspecialimage.php" method="post" enctype="multipart/form-data">
                                        <div class="row g-3">
                                            <div class="col-xxl-12 col-12 mb-3">
                                                <label class="form-label"> Role:</label>
                                                <input type="text" class="form-control" placeholder="Name of the Reviewer" name="name" id="name" value="'.$row['role'].'" readonly>
                                            </div>
                                            

                                            <input type="hidden" value="'.$editimagevariable.'" name="editid" id="editid" >
                                            <div class="col-xxl-12 col-12 mb-3">
                                            <label class="form-label">Uploaded Profile image:</label>
                                                <a href="../sp_img/'.$row['path'].'" target="_blank">'.$row['path'].'</a>
                                            ...
                                            <div class="col-xxl-12 col-12 mb-3">
                                                <label class="form-label">Info:(Provide name to display under image)</label><br>
                                                <textarea  id="info" name="info" rows="10" cols="160"  style="border:1px solid #e5e5e5;border-radius: 5px;" >'.$row['info'].'</textarea>
                                            </div>
