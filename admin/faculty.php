...
<div id="main-wrapper">
    ...
    <div class="content-body">
                ...
                <div class="row">
                        <div class="col-xxl-12 col-xl-6 col-lg-6">
                          <div class="card">
                                ...
                                <a class="btn btn-primary" href="addfm.php">+ ADD </a>
                                </div>
        ...
        <tbody>
        <?php
                        $q = mysqli_query($con, "SELECT * FROM  faculty ORDER BY ID ASC ") or die('Error197');
                                                        while ($row = mysqli_fetch_array($q)) {
                                                                echo '<tr>
                                                                <td>'.$row['info'].'</td>
                                                                <td>'.$row['role'].'</td>
                                                                <td><img src="../fm_img/'.$row['imagepath'].'" height="200" width="150"></td>
                                                                <td><a href="deletefm.php?idb='.$row['ID'].'">Delete</a></td>
                                                                </tr>';
