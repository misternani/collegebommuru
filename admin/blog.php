                        ...
                        <div class="col-xxl-12 col-xl-6 col-lg-6">
                          <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Blog Posts List</h4>
                                    
                                </div>
                               
                                <div class="card-body">
                                <div class="col-xxl-12 col-12 mb-3">
                                                <a class="btn btn-primary" href="addbp.php">+ ADD </a>
                                </div>
        ...
        <?php
                        $q = mysqli_query($con, "SELECT * FROM  blog ORDER BY ID DESC ") or die('Error197');
                                                        while ($row = mysqli_fetch_array($q)) {
                                                                echo '<tr>
                                                                <td>'.$row['title'].'</td>
                                                                <td><img src="../blog_img/'.$row['imagepath'].'" height="200" width="150"></td>
                                                                <td><a href="editbp.php?idb='.$row['ID'].'">Edit</a></td>
                                                                <td><a href="deletebp.php?idb='.$row['ID'].'">Delete</a></td>
                                                                </tr>';
