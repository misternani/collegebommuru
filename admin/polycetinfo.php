...
<div id="main-wrapper">
    ...
    <div class="content-body">
                        ...
                        <div class="col-xxl-12 col-xl-6 col-lg-6">
                          <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Polycet Information</h4>
                                    
                                </div>
                               
                                <div class="card-body">
                                <div class="col-xxl-12 col-12 mb-3">
                                                <a class="btn btn-primary" href="addpolyinfo.php">+ ADD </a>
                                </div>
        ...
        <tbody>
        <?php
                        $q = mysqli_query($con, "SELECT * FROM  polycet ORDER BY ID ASC ") or die('Error197');
                                                        while ($row = mysqli_fetch_array($q)) {
                                                                echo '<tr>
                                                                <td><img src="../pi_img/'.$row['imagepath'].'" height="350" width="350"></td>
                                                                <td><a href="deletepolyinfo.php?idb='.$row['ID'].'">Delete</a></td>
                                                                </tr>';
