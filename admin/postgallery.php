...
if (in_array($fileType1, $allowTypes) ) {
    ...
    if (move_uploaded_file($_FILES["reviewprofile"]["tmp_name"], $targetFilePath1)) {
        ...
        $query = "INSERT INTO gallery (`name`,imagepath) 
        ...
        if ($result) {
            ...
            // Button HTML
            echo '<a href="addgallery.php" style="display: inline-block; background-color: #1a73e8; padding: 5px 10px; border-radius: 8px; color: white; text-decoration: none;font-size: 38px;">Go Back</a>';
