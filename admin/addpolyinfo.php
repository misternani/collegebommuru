                        ...
                        <div class="col-xxl-12 col-xl-6 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Polycet Information</h4>
                                </div>
                                <div class="card-body">
                                    <form action="postpolyinfo.php" method="post" enctype="multipart/form-data">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xxl-12 col-12 mb-3">
                                                <div class="form-file">
                                                    <label class="form-label">Polycet Information Image:</label><br>
