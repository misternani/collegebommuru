...
<div id="main-wrapper">
    ...
    <div class="content-body">
                        ...
                        <div class="col-xxl-12 col-xl-6 col-lg-6">
                          <div class="card">
                                ...
                                <div class="col-xxl-12 col-12 mb-3">
                                                <a class="btn btn-primary" href="addgm.php">+ ADD </a>
                                </div>
        ...
        <tbody>
        <?php
                        $q = mysqli_query($con, "SELECT * FROM  g_members ORDER BY ID ASC ") or die('Error197');
                                                        while ($row = mysqli_fetch_array($q)) {
                                                                echo '<tr>
                                                                <td>'.$row['info'].'</td>
                                                                <td>'.$row['role'].'</td>
                                                                <td><img src="../gm_img/'.$row['imagepath'].'" height="200" width="150"></td>
                                                                <td><a href="deletegm.php?idb='.$row['ID'].'">Delete</a></td>
                                                                </tr>';
