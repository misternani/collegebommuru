...
<!-- .navbar -->
  ...
  <main id="main">
    <br>
        <h1 style="display: flex;justify-content: center;align-items: center;margin-top: 100px;font-weight: bold;">Vision and Mission</h1>
...
<div class="card card-body shadow p-4 align-items-start mt-3"  style="border: 0px solid rgba(255, 255, 255, 0);">
    <div class="page-view">
    <?php
             $q = mysqli_query($con, "SELECT visionmission FROM textdata") or die('Error197');
