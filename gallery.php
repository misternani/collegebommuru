    ...
    <div class="page-view">
        <section id="portfolio" class="portfolio" >
            <div class="container aos-init aos-animate" data-aos="fade-up">
              ...
              <div class="row aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" style="display: none;">
              ...
              <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" style="position: relative; height: 756.015px;">
              <?php
             $q = mysqli_query($con, "SELECT * FROM gallery") or die('Error197');
         while ($row = mysqli_fetch_array($q)) {
                echo '<div class="col-lg-4 col-md-6 portfolio-item filter-app" style="position: absolute; left: 0px; top: 0px;">
                  <div class="portfolio-wrap">
                    <img src="gallery/'.$row['imagepath'].'" class="img-fluid" alt="">
                    <div class="portfolio-info">
                      <h4>'.$row['name'].'</h4>
                      <p>'.$row['name'].'</p>
                      <div class="portfolio-links">
                        <a href="gallery/'.$row['imagepath'].'" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-fullscreen"></i></a>
