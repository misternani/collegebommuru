...
<!-- .navbar -->
  ...
  <main id="main">
    <br>
        <h1 style="display: flex;justify-content: center;align-items: center;margin-top: 100px;font-weight: bold;">Mandatory Disclosure</h1>
...
<div class="card card-body shadow p-4 align-items-start mt-3"  style="border: 0px solid rgba(255, 255, 255, 0);">
    <div class="page-view">
       <p>
       <a href="img/bcm.pdf">Mandatory Disclosure-GMR-Rajahmundry(072)</a>
    </p>
