...
<!-- .navbar -->
  ...
  <main id="main">
    <br>
        <h1 style="display: flex;justify-content: center;align-items: center;margin-top: 100px;font-weight: bold;">AICTE EOA LIST</h1>
...
<div class="card card-body shadow p-4 align-items-start mt-3"  style="border: 0px solid rgba(255, 255, 255, 0);">
    <div class="page-view">
       <p>
        <a href="#">EOA_Report 2002-2018</a><br>
        <a href="#">EOA Report_2018-2019</a><br>
        <a href="#">EOA_Report_2019-2020</a><br>
        <a href="#">EOA_Report 2020-2021</a><br>
        <a href="#">EOA_Report 2021-2022</a><br>
