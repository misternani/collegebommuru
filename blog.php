...
<!-- .navbar -->
  ...
  <main id="main">
    <br>
        <h1 style="display: flex;justify-content: center;align-items: center;margin-top: 100px;font-weight: bold;">Blog</h1>
...
<div class="card card-body shadow p-4 align-items-start mt-3"  style="border: 0px solid rgba(255, 255, 255, 0);">
    <div class="page-view" style="width: 100%;">
    <section id="blog" class="blog" style="width: 100%;">
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <?php
             $maxChars=250;
             $q = mysqli_query($con, "SELECT * FROM blog ORDER BY ID DESC") or die('Error197');
         while ($row = mysqli_fetch_array($q)) {
          if (strlen($row['content']) > $maxChars) {
            $displayText = substr($row['content'], 0, $maxChars) . "..."; // Extract the first $maxChars characters and add "..." at the end
            } else {
               $displayText = $row['content']; // The text is shorter than the maximum, so display it as is
            }
              echo '<article class="entry" style="width:100%">

              <div class="entry-img">
                <img src="blog_img/'.$row['imagepath'].'" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-content">
                ...
                <div class="read-more">
                <a href="blogpost.php?idb='.$row['ID'].'">Read More</a>
                </div>
              </div>
