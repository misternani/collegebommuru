...
<!-- .navbar -->
  ...
  <main id="main">
    <br>
        <h1 style="display: flex;justify-content: center;align-items: center;margin-top: 100px;font-weight: bold;">AP Polygrievance App</h1>
...
<div class="card card-body shadow p-4 align-items-start mt-3"  style="border: 0px solid rgba(255, 255, 255, 0);">
    <div class="page-view">
       <p>
        Ap polygrievance redressal system is an online mechanism to raise grievances on an institution by any of the student,parent,staff & Non-teaching staff of the respective organization. <br><br><b>How to register:</b><br> Student: Enter registration no, e-mail, department & create your own password.
        <br><br>
        <b>
        ...
        Parents: Enter your students registration no, your e-mail & create your own password.<br> Teaching Staff: Enter your students registration no, your e-mail & create your own password. <br>Non-Teaching Staff: Enter your students registration no, your e-mail & create your own password. When a user raises a grievance, a notification will be sent to the grievance redressal committe members of the respective institution, they can see & respond to your raised grievance.<br> App: search "ap polygrievance" in playstore Download it from there & install it in your Android Phone. So that, grievances can be lodged & redressed through your mobile app.
    </p>
